          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center">
              <button
                ...
                className="px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2"
              >
                <LogOut size={16} />
                Sign Out
              </button>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button
                onClick={handleSignOut}
                className="w-full text-left px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 border-t border-gray-200 mt-2 pt-4"
              >
                <LogOut size={18} />
                Sign Out
              </button>
